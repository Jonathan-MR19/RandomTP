Un plugin de minecraft para escoger un punto aleatorio del mundo en un anillo centrado en la posición del jugador, hecho para ser usado con spigotmc o papermc version 1.19+, necesita java 17 como minimo.
